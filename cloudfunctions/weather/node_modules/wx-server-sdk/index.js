        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    err_1 = _a.sent();
                    throw {
                        errCode: error_config_1.TCB_ERR_CODE[err_1.code] || error_config_1.TCB_ERR_CODE.SYS_ERR,
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(/*! tslib */ "tslib");
var openapi_1 = __webpack_require__(/*! ./protobuf/openapi */ "./src/api/openapi/namespace/protobuf/openapi.js");
var type_1 = __webpack_require__(/*! ../../../utils/type */ "./src/utils/type.ts");
var error_1 = __webpack_require__(/*! ../../../utils/error */ "./src/utils/error.ts");
var msg_1 = __webpack_require__(/*! ../../../utils/msg */ "./src/utils/msg.ts");
...
function getGenericOpenAPI(cloud) {
    ...
    function callWXOpenAPI(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var displayAPIName, data, pairs, key, val, contentType, fileExtension, filename, pbMessage, callResult, result, wxResp, err, e_1;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        if (Buffer.isBuffer(result)) {
                            // is buffer
                            try {
                                wxResp = openapi_1.CommOpenApiResp.decode(result);
                            }
                            catch (decodeError) {
                                // fail to parse pb, may well be tcb error
                                try {
                                    result = JSON.parse(result.toString());
                                    if (result.code && result.hasOwnProperty('message')) {
                                        // tcb error
                                        err = new error_1.CloudSDKError({
                                            errCode: error_config_1.TCB_ERR_CODE[result.code] || error_config_1.TCB_ERR_CODE.SYS_ERR,
                                            errMsg: msg_1.apiFailMsg(displayAPIName, result.message)
                                        });
                                    }
                                }
                                    ...
                                    err = new error_1.CloudSDKError({
                                        ...
                                        errMsg: msg_1.apiFailMsg(displayAPIName, "unknown wx response received: " + decodeError)
                                    });
                                }
                            }
                            if (wxResp) {
                                if (wxResp.errorCode) {
                                ...
                                else if (/(application\/json)|(text\/plain)/.test(wxResp.contentType)) {
                                    // json response
                                    ...
                                    try {
                                        ...
                                        if (/text\/plain/.test(wxResp.contentType)) {
                                            ...
                                            err = new error_1.CloudSDKError({
                                                errCode: error_config_2.ERR_CODE.WX_SYSTEM_ERROR,
                                                errMsg: msg_1.apiFailMsg(displayAPIName, "wx server internal error, response body is invalid json: " + wxResp.respData.toString())
                                            });
                                        }
                                    }
                                }
...
/***/ "./src/api/openapi/namespace/protobuf/openapi.js":
/*!*******************************************************!*\
  !*** ./src/api/openapi/namespace/protobuf/openapi.js ***!
  \*******************************************************/
/*! no static exports found */
